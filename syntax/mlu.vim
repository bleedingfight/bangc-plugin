...
syntax keyword driverFunction cnAtomicOperation cnAtomicReadOps cnCacheOperation cnCreateNotifier cnCreateQueue cnCreateQueueWithPriority cnCtxCreate cnCtxDestroy cnCtxGetApiVersion cnCtxGetConfig cnCtxGetCurrent cnCtxGetDevice cnCtxGetFlags cnCtxGetQueuePriorityRange cnCtxSetConfig cnCtxSetCurrent cnCtxSync cnDestroyNotifier cnDestroyQueue cnDeviceCanPeerAble cnDeviceGet cnDeviceGetAttribute cnDeviceGetByPCIBusId cnDeviceGetCount cnDeviceGetLocalMem cnDeviceGetName cnDeviceGetPCIBusId cnDeviceSetLocalMem cnDeviceTotalMem cnDriverGetVersion cnFree cnFreeHost cnGetCtxConfigParam cnGetCtxMaxParallelUnionTasks cnGetDeviceCount cnGetDriverVersion cnGetErrorName cnGetErrorString cnGetExportFunction cnGetLibVersion cnGetMemAttribute cnGetMemAttributes cnInit cnInvokeKernel cnIpcCloseMemHandle cnIpcGetMemHandle cnIpcOpenMemHandle cnKernelGetAttribute cnMalloc cnMallocConstant cnMallocExt cnMallocExtCached cnMallocExtZone cnMallocExtZoneCached cnMallocFrameBuffer cnMallocHost cnMallocNode cnMallocNodeConstant cnMallocPeerAble cnMallocSecurity cnMemGetAddressRange cnMemGetInfo cnMemGetNodeInfo cnMemMerge cnMemcpy cnMemcpyAsync cnMemcpyDtoD cnMemcpyDtoDAsync cnMemcpyDtoH cnMemcpyDtoHAsync cnMemcpyHtoD cnMemcpyHtoDAsync cnMemcpyPeer cnMemcpyPeerAsync cnMemsetD cnMmap cnMmapCached cnModuleGetKernel cnModuleGetSymbol cnModuleLoad cnModuleLoadFatBinary cnModuleUnload cnMunmap cnNotifierElapsedExecTime cnNotifierElapsedTime cnPlaceNotifier cnQueryNotifier cnQueryQueue cnQueueAtomicOperation cnQueueGetContext cnQueueSync cnQueueWaitNotifier cnSetCtxConfigParam cnSetMemAttribute cnSetMemRangeAttribute cnSharedContextAcquire cnSharedContextGetState cnSharedContextRelease cnSharedContextReset cnSharedContextSetFlags cnVBAllocBlock cnVBBlockRefDec cnVBBlockRefInc cnVBCacheOperation cnVBCreatePool cnVBCreatePoolV cnVBDestroyPool cnVBExit cnVBExitMod cnVBFreeBlock cnVBGetBlkUva cnVBGetComCfg cnVBGetModCfg cnVBGetStat cnVBGetUserMeta cnVBHandle cnVBInit cnVBInitMod cnVBMmapPool cnVBMunmapPool cnVBPhy cnVBPutBlkUva cnVBSetComCfg cnVBSetModCfg cnVBSetUserMeta cnVBSetUserMetaCfg cnWaitNotifier cnZmalloc cnZmallocNode 
highlight link bangcKeyword Keyword
highlight link bangcFunction Function
highlight link bangcDriver Function
